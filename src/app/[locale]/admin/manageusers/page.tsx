  ...
  try {
    ...
    const { error: accountError } = await supabase
      ...
      .insert({
        ...
        numero_compte: userData.numero_compte || generateAccountNumber(),
    ...
    toast.error(`Erreur lors de l'approbation: ${error instanceof Error ? error.message : 'Erreur inconnue'}`)
  }
}
